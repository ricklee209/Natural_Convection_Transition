...
#pragma omp parallel for private(\
	...
	_k,__k,k\
			...
			for (j = 2; j <= nyy;j++) {
				...
				/* viscous*/
				mu_E = mu_L*pow((Tx/298.0592),1.5)*(298.0592+110.)/(Tx+110.);
				Pr_E = Pr_L;
				...
				mu_E = mu_L*pow((Ty/298.0592),1.5)*(298.0592+110.)/(Ty+110.);
				Pr_E = Pr_L;
				...
				mu_E = mu_L*pow((Tz/298.0592),1.5)*(298.0592+110.)/(Tz+110.);
				Pr_E = Pr_L;
