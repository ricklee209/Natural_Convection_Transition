	...
	if (myid == 0) {
		...
		for (j = 1; j <= nyy; j++) {
			for (k = 2; k < nzz; k++) {
				...
				U1_[istart-2][j][k] = U1_[istart-1][j][k];
				U2_[istart-2][j][k] = U2_[istart-1][j][k];
				U3_[istart-2][j][k] = U3_[istart-1][j][k];
				U4_[istart-2][j][k] = U4_[istart-1][j][k];
				U5_[istart-2][j][k] = U5_[istart-1][j][k];
	...
	if (myid == nproc-1) {
		...
		for (j = 1; j <= nyy; j++) {
			for (k = 2; k < nzz; k++) {
				...
				U1_[iend+2][j][k] = U1_[iend+1][j][k];
				U2_[iend+2][j][k] = U2_[iend+1][j][k];
				U3_[iend+2][j][k] = U3_[iend+1][j][k];
				U4_[iend+2][j][k] = U4_[iend+1][j][k];
				U5_[iend+2][j][k] = U5_[iend+1][j][k];
